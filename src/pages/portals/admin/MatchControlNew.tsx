...
import { Trophy, Search, Filter, Play, Pause } from 'lucide-react';
import { supabase } from '../../../lib/supabase';
import MatchDashboard from './MatchDashboard';

export default function MatchControlNew() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-white/40">Select competition and control matches</p>
          </div>
        </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-black uppercase">
                {selectedCompetition.name} - Matches ({matches.length})
              </h2>
            </div>
